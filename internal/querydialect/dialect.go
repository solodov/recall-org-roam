// Package querydialect layers recall-org-roam operators like is:overdue and due:today on top of raw Bleve query-string syntax while hiding archived entries by default.
...
// Compile turns one mixed recall-org-roam query into a Bleve query.
//
